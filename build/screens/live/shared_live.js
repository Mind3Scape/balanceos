...
function UniverseFieldLive({
  ...
  var orbs = React.useMemo(function () {
    var out = [];
    for (var i = 0; i < N; i++) {
      var r01 = Math.sqrt((i + 1) / N),
        ang = i * GA;
      out.push({
        x: Math.cos(ang) * r01 * 44,
        y: Math.sin(ang) * r01 * 44,
        size: lerp(16, 3.4, r01),
        op: lerp(0.95, 0.16, r01),
        col: PAL[i % PAL.length],
        ring: i < 12,
        delay: (r01 * 0.5).toFixed(2)
      });
    }
    return out;
  }, []);
  var dust = React.useMemo(function () {
    ...
    for (var d = 0; d < 22; d++) {
      var a = d * 2.6182,
        rr = d * 37 % 100 / 100;
      out.push({
        x: Math.cos(a) * (10 + rr * 44),
        y: Math.sin(a) * (10 + rr * 44),
        s: 1 + d % 3 * 0.6,
        o: 0.18 + d % 4 * 0.06
      });
    }
  ...
  var node = /*#__PURE__*/React.createElement("div", {
    ...
    style: {
      ...
      zIndex: 300,
      overflow: "hidden",
      background: "radial-gradient(120% 90% at 50% 42%, #1a2238 0%, #0d1322 46%, #060912 100%)",
      animation: "bosUniFade 0.55s ease both"
    }
    ...
    style: {
      ...
      width: 0,
      height: 0,
      animation: "bosUniSpinR 220s linear infinite"
    }
  }, dust.map(function (s, i) {
    return /*#__PURE__*/React.createElement("span", {
      key: "d" + i,
      "aria-hidden": true,
      style: {
    ...
    style: {
      ...
      width: 0,
      height: 0,
      animation: "bosUniSpin 150s linear infinite"
    }
    ...
    return /*#__PURE__*/React.createElement("span", {
      ...
      style: {
        position: "absolute",
        left: o.x.toFixed(2) + "vmin",
        top: o.y.toFixed(2) + "vmin",
        transform: "translate(-50%,-50%)",
        animation: "bosUniPop 0.7s ease " + o.delay + "s both"
      }
    }, o.ring && /*#__PURE__*/React.createElement("span", {
      style: {
        position: "absolute",
        left: "50%",
        top: "50%",
      ...
      style: {
        ...
        background: o.col,
        opacity: o.op,
        boxShadow: "0 0 " + (o.size * 1.2).toFixed(1) + "px " + o.col
      }
    }));
  })), /*#__PURE__*/React.createElement("div", {
    style: {
      ...
      top: "50%",
      transform: "translate(-50%,-50%)",
      animation: "bosUniPop 0.6s ease 0.1s both"
    }
  }, /*#__PURE__*/React.createElement("div", {
    "aria-hidden": true,
    style: {
      ...
      transform: "translate(-50%,-50%)",
      borderRadius: "50%",
      background: "radial-gradient(circle, rgba(140,170,230,0.32), transparent 70%)",
      filter: "blur(6px)"
    }
  }), /*#__PURE__*/React.createElement("div", {
    style: {
  ...
  }, "\u0412\u0441\u0435\u043B\u0435\u043D\u043D\u0430\u044F"), /*#__PURE__*/React.createElement("div", {
    style: {
      fontSize: 13,
      color: "rgba(200,215,255,0.5)",
      marginTop: 3
    }
  }, "\u0442\u044B \u043D\u0435 \u043E\u0434\u0438\u043D \u0432 \u043F\u043E\u0442\u043E\u043A\u0435")), /*#__PURE__*/React.createElement("button", {
    onClick: onClose,
    "aria-label": "\u0417\u0430\u043A\u0440\u044B\u0442\u044C",
    className: "tap",
    style: {
