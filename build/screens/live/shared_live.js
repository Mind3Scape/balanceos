...
function bosGoalHero(color, isDark) {
  ...
  var c1, c2;
  if (neutral) {
    c1 = isDark ? "#27272e" : "#F2F2F6";
    c2 = isDark ? "#191920" : "#E3E3EC";
  } else {
    c1 = bosMixHex(color, isDark ? "#0e0e12" : "#ffffff", isDark ? 0.50 : 0.66);
    c2 = bosMixHex(color, isDark ? "#0e0e12" : "#ffffff", isDark ? 0.26 : 0.40);
  }
