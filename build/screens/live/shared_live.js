...
function UniverseFieldLive({
  ...
  function planet(kind, it, pd) {
    if (kind === "avatar") return typeof BuddyFaceLive === "function" ? /*#__PURE__*/React.createElement(BuddyFaceLive, {
      avatar: it && it.avatar,
      name: it && it.name,
      size: pd
    }) : null;
    if (kind === "emoji") return /*#__PURE__*/React.createElement("div", {
      style: {
        width: pd,
        height: pd,
        borderRadius: "50%",
        background: discBg,
        boxShadow: "inset 0 0 0 0.5px rgba(0,0,0,0.06), 0 1px 3px rgba(0,0,0,0.12)",
        display: "grid",
        placeItems: "center",
        fontSize: Math.round(pd * 0.62)
      }
    }, typeof bosIcon === "function" ? bosIcon(it, Math.round(pd * 0.62), null) : it);
    return /*#__PURE__*/React.createElement("div", {
      style: {
        width: pd,
        height: pd,
        borderRadius: "50%",
        background: discBg,
        boxShadow: "inset 0 0 0 0.5px rgba(0,0,0,0.06), 0 1px 2px rgba(0,0,0,0.1)"
      }
    }); // bead
  }
...
function HomeWeekStripLive(props) {
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    if (on) {
      cs.background = doneFill;
      cs.boxShadow = doneGlass;
    } else if (isToday) {
      cs.background = isDark ? "rgba(255,255,255,0.03)" : "rgba(0,0,0,0.015)";
      cs.border = "1.5px dashed " + dash;
    } else {
      cs.background = emptyBg;
      cs.boxShadow = emptyInset;
    }
    return /*#__PURE__*/React.createElement("div", {
      key: i,
      style: {
