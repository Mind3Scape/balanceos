...
function bosChallengeBonusXPLive(app) {
  ...
  var sum = 0,
    c = app.claimedChallenges;
  for (var k in c) {
    if (Object.prototype.hasOwnProperty.call(c, k)) sum += c[k] | 0;
  }
  return sum;
}
...
var BOS_ACHIEVEMENTS_LIVE = [{
  ...
  i: "🤝",
  t: "Не один",
  d: "Собрал своих или позвал друга",
  xp: 100,
  accent: "#5FA8FF",
  how: "Создай совместную цель или пригласи друга",
  test: function (c) {
...
function bosAchievementBonusXPLive(app) {
  var c = bosAchContextLive(app),
    sum = 0;
  for (var i = 0; i < BOS_ACHIEVEMENTS_LIVE.length; i++) {
    if (BOS_ACHIEVEMENTS_LIVE[i].test(c)) sum += BOS_ACHIEVEMENTS_LIVE[i].xp || 0;
  }
  return sum;
}
function bosEarnedAchIdsLive(app) {
  var c = bosAchContextLive(app),
    ids = [];
  for (var i = 0; i < BOS_ACHIEVEMENTS_LIVE.length; i++) {
    if (BOS_ACHIEVEMENTS_LIVE[i].test(c)) ids.push(BOS_ACHIEVEMENTS_LIVE[i].id);
  }
  return ids;
}
function bosAchByIdLive(id) {
  for (var i = 0; i < BOS_ACHIEVEMENTS_LIVE.length; i++) {
    if (BOS_ACHIEVEMENTS_LIVE[i].id === id) return BOS_ACHIEVEMENTS_LIVE[i];
  }
  return null;
}
...
function GuideLive() {
  ...
  var part = function (roman, title, sub) {
    ...
    }, roman), /*#__PURE__*/React.createElement("span", {
      style: {
        flex: 1,
        height: 1,
  ...
  var goldPill = function (txt) {
    return /*#__PURE__*/React.createElement("span", {
      style: {
        ...
        padding: "3px 9px",
        borderRadius: 999,
        boxShadow: "0 4px 12px rgba(239,159,20,0.35)",
        whiteSpace: "nowrap"
      }
    }, txt);
  };
  var ring = function (size, pctv, inner) {
    ...
    return /*#__PURE__*/React.createElement("span", {
      ...
      r: r,
      fill: "none",
      stroke: "url(#bosGdRing)",
      strokeWidth: "3",
      strokeLinecap: "round",
      strokeDasharray: c,
      strokeDashoffset: c * (1 - pctv)
  ...
  return /*#__PURE__*/React.createElement("div", {
  ...
  }, "\u041E\u0434\u043D\u0430 \u043E\u0442\u043C\u0435\u0442\u043A\u0430 \u2014 \u0446\u0435\u043B\u0430\u044F \u0432\u0441\u0435\u043B\u0435\u043D\u043D\u0430\u044F"), /*#__PURE__*/React.createElement("div", {
    style: {
      fontSize: 14,
      color: "var(--text-3)",
      marginTop: 8,
  ...
  }, "\u041F\u043E\u043B\u043D\u044B\u0439 \u0433\u0438\u0434 \u043F\u043E \u043C\u0435\u0445\u0430\u043D\u0438\u043A\u0430\u043C: \u0447\u0435\u0442\u044B\u0440\u0435 \u0441\u0442\u0443\u043F\u0435\u043D\u0438 \u2014 \u043E\u0442 \u043E\u0434\u043D\u043E\u0433\u043E \u043A\u0430\u0441\u0430\u043D\u0438\u044F \u0434\u043E \u043A\u0430\u0440\u0442\u044B \u0432\u0441\u0435\u0445 \u043B\u044E\u0434\u0435\u0439. \u0412\u0441\u0451, \u0447\u0442\u043E \u0437\u0434\u0435\u0441\u044C \u043D\u0430\u043F\u0438\u0441\u0430\u043D\u043E, \u2014 \u043D\u0430\u0441\u0442\u043E\u044F\u0449\u0438\u0435 \u043F\u0440\u0430\u0432\u0438\u043B\u0430 \u0438 \u043D\u0430\u0441\u0442\u043E\u044F\u0449\u0438\u0435 \u0446\u0438\u0444\u0440\u044B.")), part("I", "Каждый день", "Фундамент: касание, ритм недели и твоё состояние."), kicker("01", "Самое маленькое"), /*#__PURE__*/React.createElement("div", {
    style: cardStyle
  }, visWrap(/*#__PURE__*/React.createElement("div", {
    style: {
      position: "relative",
      width: "100%",
      maxWidth: 300
  ...
  }, "\u0417\u0430\u0440\u044F\u0434\u043A\u0430"), /*#__PURE__*/React.createElement("div", {
    style: {
      fontSize: 11.5,
      color: "var(--text-4)",
      marginTop: 1
    }
  }, "\u0441\u0435\u0433\u043E\u0434\u043D\u044F \xB7 \u0441\u0434\u0435\u043B\u0430\u043D\u043E")), /*#__PURE__*/React.createElement("span", {
    style: {
      width: 30,
      height: 30,
      borderRadius: "50%",
  ...
  }, goldPill("✦ +10 XP")))), body("Отметка", "Сделал дело — коснулся плитки, вот и вся церемония. Каждая отметка даёт +10 XP. Отметить можно где угодно: на главной, на «Привычках», внутри цели или круга — это ОДИН и тот же журнал.")), kicker("02", "Ритм недели"), /*#__PURE__*/React.createElement("div", {
    style: cardStyle
  }, visWrap(/*#__PURE__*/React.createElement("div", {
    style: {
      width: "100%",
  ...
  }, "\uD83D\uDD25 \u0441\u0435\u0440\u0438\u044F 6 \u0434\u043D.")), /*#__PURE__*/React.createElement("div", {
    style: {
      display: "flex",
      gap: 6,
      justifyContent: "space-between"
    ...
    return /*#__PURE__*/React.createElement("div", {
      ...
      style: {
        ...
        height: 26,
        borderRadius: "50%",
        background: on ? "#34C759" : isDark ? "rgba(255,255,255,0.08)" : "rgba(0,0,0,0.06)",
        boxShadow: on ? "0 3px 8px rgba(52,199,89,0.35)" : "none"
      }
    }), /*#__PURE__*/React.createElement("span", {
      style: {
        fontSize: 9.5,
  ...
  }, goldPill("✦ весь день закрыт · +30 XP")))), body("Серия и «день закрыт»", "Отмечаешься день за днём — на плитке растёт огонёк серии 🔥. Закрыл ВСЕ привычки дня — сверху падает +30 XP. И главное правило: пропуск НИЧЕГО не сжигает — ни уровень, ни опыт. Просто продолжай со следующего дня.")), kicker("03", "Как ты?"), /*#__PURE__*/React.createElement("div", {
    style: cardStyle
  }, visWrap(/*#__PURE__*/React.createElement("div", {
    style: {
      width: "100%",
  ...
  }, "\u0421\u0435\u0439\u0447\u0430\u0441 \xB7 \uD83C\uDF24 \u0440\u043E\u0432\u043D\u043E"), /*#__PURE__*/React.createElement("div", {
    style: {
      position: "relative",
      height: 10,
      borderRadius: 999,
      marginTop: 12,
      background: "linear-gradient(90deg,#8FB4E8,#7ED2A8,#FEDE6B,#F5A46B)"
    }
  }, /*#__PURE__*/React.createElement("span", {
    style: {
      position: "absolute",
      ...
      borderRadius: "50%",
      background: "#fff",
      boxShadow: "0 2px 8px rgba(0,0,0,0.25), inset 0 0 0 0.5px rgba(0,0,0,0.06)"
    }
  })), /*#__PURE__*/React.createElement("div", {
    style: {
      fontSize: 11.5,
  ...
  }, "\u2026\u0438 \u043E\u0434\u043D\u0430 \u0441\u0442\u0440\u043E\u043A\u0430 \u0432 \u0434\u043D\u0435\u0432\u043D\u0438\u043A: \xAB\u0443\u0441\u043F\u0435\u043B \u0434\u043E \u0440\u0430\u0431\u043E\u0442\u044B, \u0434\u043E\u0432\u043E\u043B\u0435\u043D \u0441\u043E\u0431\u043E\u0439\xBB"))), body("Состояние и дневник", "Раз в день — один свайп «как ты?» и, если хочется, пара слов в дневник. Это твоя личная погода: по ней ИИ подстраивает подсказки, а календарь потом показывает, как состояние ходит вместе с привычками.")), part("II", "Рост", "Опыт, уровень и награды — след пути, а не счётчик вины."), kicker("04", "Твой след"), /*#__PURE__*/React.createElement("div", {
    style: cardStyle
  }, /*#__PURE__*/React.createElement("div", {
    style: {
  ...
  }, ring(88, 0.72, /*#__PURE__*/React.createElement("span", {
    style: {
      position: "relative",
      width: 68,
      height: 68,
  ...
  }, "\u043A\u043E\u043B\u044C\u0446\u043E \u0437\u0430\u043F\u043E\u043B\u043D\u044F\u0435\u0442\u0441\u044F \u2192 \u0443\u0440\u043E\u0432\u0435\u043D\u044C \u0440\u0430\u0441\u0442\u0451\u0442")), body("Опыт и уровень", "Весь XP стекается в одно место — золотое кольцо вокруг твоего лица. Кольцо заполнилось — уровень вырос, навсегда: он не обнуляется и не «сгорает по понедельникам». Уровень видят друзья, и именно он открывает двери дальше — к партнёрам и нетворку.")), kicker("05", "Откуда капает XP"), /*#__PURE__*/React.createElement("div", {
    style: cardStyle
  }, /*#__PURE__*/React.createElement("div", {
    style: {
  ...
  }, [["✅", "Отметка привычки", "+10"], ["🌅", "Весь день закрыт", "+30"], ["🤝", "Друг пришёл по твоей ссылке", "+150"], ["🏁", "Вехи друзей · 3 / 7 / 15 / 30", "+300…3000"], ["⚡", "Финиш челленджа", "+40…100"], ["🏆", "Достижения", "разово"]].map(function (r, i) {
    return /*#__PURE__*/React.createElement("div", {
      key: i,
      style: {
        display: "flex",
  ...
  })), body("Экономика опыта", "Это весь прайс — честный и открытый. Никаких скрытых умножителей: самое ценное здесь — люди. Позвать друга даёт больше, чем неделя отметок, потому что вместе вы удержитесь оба.")), kicker("06", "Медали за путь"), /*#__PURE__*/React.createElement("div", {
    style: cardStyle
  }, visWrap(/*#__PURE__*/React.createElement("div", {
    style: {
      display: "flex",
  ...
  }))), body("Достижения", "Медали выдаются за настоящие вехи: первую привычку, серию, первого человека рядом. Каждая — разовый бонус XP и след на странице «Я». Коллекция — в «Я» → «Достижения».")), kicker("07", "Быстрый старт с бонусом"), /*#__PURE__*/React.createElement("div", {
    style: cardStyle
  }, visWrap(/*#__PURE__*/React.createElement("div", {
    style: {
      display: "flex",
  ...
  }, "\u0425\u043E\u043B\u043E\u0434\u043D\u044B\u0439 \u0434\u0443\u0448 \xB7 7 \u0434\u043D\u0435\u0439"), /*#__PURE__*/React.createElement("span", {
    style: {
      fontSize: 10.5,
      fontWeight: 800,
      color: "#9a6800",
  ...
  }, "+50 XP")), /*#__PURE__*/React.createElement("span", {
    style: {
      fontSize: 11.5,
      color: "var(--text-4)",
      fontWeight: 600
    }
  }, "\u043B\u0435\u043D\u0442\u0430 \u0447\u0435\u043B\u043B\u0435\u043D\u0434\u0436\u0435\u0439 \u2014 \u043D\u0430\u0434 \xAB\u041F\u0440\u0438\u0432\u044B\u0447\u043A\u0430\u043C\u0438\xBB \u0438 \u0432 \xAB\u041D\u0430\u0439\u0442\u0438\xBB"))), body("Челленджи", "Готовые вызовы на несколько дней: тапнул — привычка создана, серия пошла. Дотянул до финиша — бонус XP сверху. Пропустил день — бонус НЕ сгорает: правило «ничего не сжигается» работает и тут.")), part("III", "Вместе", "Всё в Balance может быть совместным — так держится дольше."), kicker("08", "Одна орбита"), /*#__PURE__*/React.createElement("div", {
    style: cardStyle
  }, /*#__PURE__*/React.createElement("div", {
    style: {
      padding: "12px 16px 0",
  ...
  }, "\uD83C\uDF05")), body("Совместные цели и привычки", "Любую привычку можно вести вдвоём (вы видите отметки друг друга), а цель — целым кругом: общий счёт, лица на одной орбите. Привычка круга приходит к тебе как личная — отметка где угодно попадает в общий журнал.")), kicker("09", "Правила круга"), /*#__PURE__*/React.createElement("div", {
    style: cardStyle
  }, /*#__PURE__*/React.createElement("div", {
    style: {
      padding: "16px 16px 2px",
  ...
  }, [["👑", "Условия задаёт создатель", "Привычки круга — его правила игры; участник их не удаляет."], ["🧳", "«Убрать с моей страницы»", "Не хочешь вести у себя — убери; история и опыт целы, в круге всё остаётся."], ["↩️", "«Вернуть к себе»", "Передумал — на странице круга одна кнопка возвращает привычку."]].map(function (r, i) {
    return /*#__PURE__*/React.createElement("div", {
      key: i,
      style: {
        display: "flex",
  ...
  })), body("Кто за что отвечает", "Круг — как поход с тренером: маршрут задаёт ведущий, а идёте вы все вместе. Выйти из круга можно всегда — это отдельное действие на его плитке, и твоя история остаётся с тобой.")), kicker("10", "Живой пульс круга"), /*#__PURE__*/React.createElement("div", {
    style: cardStyle
  }, visWrap(/*#__PURE__*/React.createElement("div", {
    style: {
      width: "100%",
  ...
  }, "\u042F \u0441\u0435\u0433\u043E\u0434\u043D\u044F \u0443\u0441\u043F\u0435\u043B \u0434\u043E \u0440\u0430\u0431\u043E\u0442\u044B! \uD83D\uDCAA")), /*#__PURE__*/React.createElement("div", {
    style: {
      display: "flex",
    ...
    style: {
      background: isDark ? "#f2f2f5" : "#0a0a0a",
  ...
  }, "\u0413\u043E\u0440\u0436\u0443\u0441\u044C! \u042F \u0432\u0435\u0447\u0435\u0440\u043E\u043C \uD83C\uDF19")), /*#__PURE__*/React.createElement("div", {
    style: {
      display: "flex",
      justifyContent: "center",
      marginTop: 4
  ...
  }))))), body("Чат и уведомления", "В каждом круге — живой чат: сообщения долетают мгновенно, можно кидать фото. А колокольчик на главной собирает всё важное: заявки в твои круги, «друг присоединился к привычке», новые сообщения. Внутри приложения — и никакого спама в Telegram.")), kicker("11", "Твои люди"), /*#__PURE__*/React.createElement("div", {
    style: cardStyle
  }, visWrap(/*#__PURE__*/React.createElement("div", {
    style: {
      width: "100%",
  ...
  }, "\u0412\u0435\u0445\u0430 \xB7 +300 XP \u0431\u043E\u043D\u0443\u0441\u043E\u043C"), /*#__PURE__*/React.createElement("span", {
    style: {
      fontSize: 11.5,
      fontWeight: 700,
      opacity: 0.8
    }
  }, "2 \u0438\u0437 3")), /*#__PURE__*/React.createElement("div", {
    style: {
      display: "flex",
      gap: 4
    }
    ...
    return /*#__PURE__*/React.createElement("span", {
      ...
      style: {
        ...
        height: 6,
        borderRadius: 999,
        background: j < 2 ? "#0a0a0a" : "rgba(10,10,10,0.18)"
      }
    });
  })))), body("Друзья и вехи", "Каждый, кто придёт по твоей ссылке, встаёт на твою орбиту на «Я» — и приносит +150 XP. А вехи добавляют сверху: 3 друга → +300, 7 → +700, 15 → +1500, 30 → +3000. В «Друзьях» видно живой прогресс до следующей.")), part("IV", "Мир", "Куда ведёт уровень: партнёры, нетворк и карта всех."), kicker("12", "Куда тратить"), /*#__PURE__*/React.createElement("div", {
    style: cardStyle
  }, visWrap(/*#__PURE__*/React.createElement("div", {
    style: {
      position: "relative",
      ...
      overflow: "hidden",
      background: "linear-gradient(135deg,#FEDE34,#EF9F14)",
      boxShadow: "0 10px 26px rgba(239,159,20,0.35)",
      padding: "14px 16px",
      color: "#0a0a0a"
    }
  }, /*#__PURE__*/React.createElement("div", {
    ...
    style: {
      position: "absolute",
      inset: 0,
      background: "radial-gradient(circle at 85% 10%, rgba(255,255,255,0.45) 0%, transparent 55%)",
      pointerEvents: "none"
    }
  }), /*#__PURE__*/React.createElement("div", {
    style: {
  ...
  }, "\u041F\u0430\u0440\u0442\u043D\u0451\u0440\u0441\u043A\u0438\u0439 \u0431\u0438\u043B\u0435\u0442"), /*#__PURE__*/React.createElement("div", {
    style: {
      fontSize: 18,
      fontWeight: 800,
      letterSpacing: "-0.3px",
  ...
  }, "\u2726 BAL-2481")), /*#__PURE__*/React.createElement("span", {
    style: {
      fontSize: 10.5,
      fontWeight: 800,
  ...
  }, "\u0441\u043A\u043E\u0440\u043E")), /*#__PURE__*/React.createElement("div", {
    "aria-hidden": true,
    style: {
      position: "relative",
  ...
  }, "\u043F\u0440\u0435\u0434\u044A\u044F\u0432\u0438 \u043A\u043E\u0434 \u2014 \u043F\u043E\u043B\u0443\u0447\u0438 \u0436\u0438\u0432\u043E\u0435"))), body("Партнёры", "XP и уровень — не просто цифры: в «Найти» партнёры меняют их на реальное — программы, разборы, скидки. И партнёром может вырасти ЛЮБОЙ пользователь: это уровень и доверие, а не должность. Билет с кодом уже в работе.")), kicker("13", "Люди по делам"), /*#__PURE__*/React.createElement("div", {
    style: cardStyle
  }, /*#__PURE__*/React.createElement("div", {
    style: {
  ...
  }, "\uD83D\uDD12 \u041E\u0442\u043A\u0440\u043E\u0435\u0442\u0441\u044F \u0441 10 \u0443\u0440\u043E\u0432\u043D\u044F"))), body("Нетворк", "С 10 уровня открываются «Люди» — нетворк по делам: кто чем живёт, у кого какой ритм, к кому идти за помощью или партнёрством. Уровень — твой пропуск, и его не купить: только прожить. А часть кругов открывается иначе — ачивкой за пройденный тренинг, сразу.")), kicker("14", "Самое большое"), /*#__PURE__*/React.createElement("div", {
    style: cardStyle
  }, /*#__PURE__*/React.createElement("div", {
    style: {
      padding: "16px 16px 0"
    ...
    return /*#__PURE__*/React.createElement("span", {
      ...
      style: {
        ...
        height: d[2],
        borderRadius: "50%",
        background: "linear-gradient(165deg, rgba(255,255,255,0.35), rgba(255,255,255,0.08) 55%), rgba(255,255,255,0.14)",
        boxShadow: "inset 0 1px 0.5px rgba(255,255,255,0.4), 0 6px 18px rgba(0,0,0,0.35)",
        display: "grid",
        placeItems: "center",
        fontSize: d[2] * 0.5
      }
  ...
  }, "\u0412\u0441\u0435\u043B\u0435\u043D\u043D\u0430\u044F \xB7 \u0432\u0441\u0435 \u0441\u0438\u0441\u0442\u0435\u043C\u044B"))), body("Вселенная", "Каждый в Balance — своя система: человек в центре, привычки — планеты на орбитах. «Вселенная» на странице «Я» показывает всех — анонимно, как огни ночного города: имён не видно, но видно, что город живой. Ты уже один из этих огней.")), /*#__PURE__*/React.createElement("button", {
    onClick: back,
    className: "tap",
    style: {
      width: "100%",
  ...
  }, "\u041D\u0430\u0447\u0430\u043B\u0438!"), /*#__PURE__*/React.createElement("button", {
    onClick: function () {
      navigate("ai-chat", {
        prompt: "Объясни, как устроен Balance и с чего мне лучше начать"
      });
    },
    className: "tap",
    style: {
  ...
  }, "\u041E\u0441\u0442\u0430\u043B\u0438\u0441\u044C \u0432\u043E\u043F\u0440\u043E\u0441\u044B \u2014 \u0441\u043F\u0440\u043E\u0441\u0438 Balance AI \u203A"));
}
