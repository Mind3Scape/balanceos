...
async function bosAiBrief(app) {
  ...
  try {
    ...
    if (parsed) {
      ...
      var chats = merged.filter(p => !isAct(p)),
        acts = merged.filter(isAct);
      var mixed = [];
      for (var k = 0; k < 2; k++) {
        if (chats[k]) mixed.push(chats[k]);
        if (acts[k]) mixed.push(acts[k]);
      }
      var rest = chats.slice(2).concat(acts.slice(2));
      for (var _k = 0; mixed.length < 4 && _k < rest.length; _k++) mixed.push(rest[_k]);
...
function AchievementUnlock({
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    style: {
      ...
      placeItems: "center",
      padding: 28,
      animation: "achFade 0.3s ease both"
    }
  }, /*#__PURE__*/React.createElement("div", {
    ...
    style: {
      ...
      overflow: "hidden",
      background: "#ffffff",
      boxShadow: "0 24px 70px rgba(20,20,40,0.22), inset 0 1px 0 rgba(255,255,255,0.9)",
      animation: "achPop 0.5s cubic-bezier(0.22,1,0.36,1) both"
    }
  }, /*#__PURE__*/React.createElement("div", {
    "aria-hidden": true,
    style: {
    ...
    style: {
      ...
      margin: "20px auto 0",
      position: "relative",
      animation: "achEmblem 0.55s cubic-bezier(0.34,1.56,0.64,1) 0.12s both"
    }
  }, /*#__PURE__*/React.createElement("div", {
    "aria-hidden": true,
    style: {
  ...
  }, ach.t), /*#__PURE__*/React.createElement("div", {
    style: {
      fontSize: 15,
      color: "#8a8a8e",
      marginTop: 7,
  ...
  }, "\u041A\u043B\u0430\u0441\u0441!"))), /*#__PURE__*/React.createElement("style", null, `
