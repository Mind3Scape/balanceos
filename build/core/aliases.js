...
function _orbStart() {
  if (_orbRAF == null && _orbSubs.size && !(typeof document !== "undefined" && document.hidden)) _orbRAF = requestAnimationFrame(_orbTick);
}
function _orbStop() {
  if (_orbRAF != null) {
    cancelAnimationFrame(_orbRAF);
    _orbRAF = null;
  }
}
if (typeof document !== "undefined") document.addEventListener("visibilitychange", () => {
  if (document.hidden) _orbStop();else _orbStart();
});
...
function _siriPropsEq(a, b) {
  return a.size === b.size && a.r === b.r && a.seed === b.seed && a.intensity === b.intensity && a.t === b.t && _orbTintEq(a.tint, b.tint);
}
