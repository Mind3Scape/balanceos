...
var BOS_AI_MODEL = "nvidia/nemotron-3-ultra-550b-a55b:free"; // David 2026-07-04 — поставить эту :free-модель
...
var BOS_AI_MODELS = [BOS_AI_MODEL, "openrouter/owl-alpha", "deepseek/deepseek-chat-v3-0324", "meta-llama/llama-3.3-70b-instruct:free"];
...
async function aiRaw(messages) {
  ...
  var models = typeof BOS_AI_MODELS !== "undefined" && BOS_AI_MODELS.length ? BOS_AI_MODELS : [BOS_AI_MODEL];
