...
const LIVE_SCREENS = {
  ...
  // Карточка человека переписана с нуля (v868): PersonScreenLive в community_live.jsx.
  // Прежний NetPersonDetailLive жив в shared_live, но с экрана снят вместе с лесенкой.
  "net-person": () => PersonScreenLive,
