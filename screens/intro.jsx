...
function IntroScreen() {
  ...
  const slides = [
    { mode: "awake",    eyebrow: "BalanceOS",            title: "Сначала — состояние",        sub: "Это приложение про одно — управление своим состоянием. Не спорт и не успех. Состояние.", glow: "rgba(140,180,230,0.42)" },
    { mode: "comfort",  eyebrow: "Слабое состояние",      title: "Зона комфорта сжимается",    sub: "Когда мало энергии, мир сужается до привычного круга. Новое кажется недоступным — и ты остаёшься внутри.", glow: "rgba(96,120,150,0.34)" },
    { mode: "state",    eyebrow: "Сильное состояние",     title: "Зона комфорта растёт",       sub: "Из цельного, наполненного состояния граница расширяется. Ты выходишь за неё — видеть и чувствовать новое.", glow: "rgba(160,205,245,0.52)" },
    { mode: "compound", eyebrow: "День за днём",           title: "Состояние укрепляется",      sub: "Каждый маленький шаг возвращается к тебе и питает ядро. Зона растёт виток за витком.", glow: "rgba(180,210,240,0.45)" },
    { mode: "together", eyebrow: "Ты не один",            title: "Вместе — дальше",            sub: "Когда связи крепнут, ты заходишь ещё дальше за прежние границы.", glow: "rgba(150,185,225,0.42)" },
    { mode: "habits",   eyebrow: "Живая система",         title: "Привычки держат состояние",  sub: "У каждой привычки свой ритм и притяжение. Вместе они удерживают тебя в силе.", glow: "rgba(170,205,240,0.48)" },
    { mode: "mood",     eyebrow: "Войди",                title: "Как ты сейчас?",             sub: "С этого начинается контроль. Выбери состояние — сфера последует за тобой.", glow: "rgba(180,210,240,0.45)" },
  ];
  ...
  const moods = [
    { i: "😌", t: "Спокойствие",      c: "rgba(180,210,240,0.20)" },
    { i: "⚡️", t: "Энергия", c: "rgba(220,235,255,0.22)" },
    { i: "😔", t: "Упадок",       c: "rgba(120,150,180,0.18)" },
    { i: "😤", t: "Стресс",  c: "rgba(150,180,215,0.18)" },
    { i: "🙂", t: "Ровно",    c: "rgba(170,200,230,0.20)" },
    { i: "🔥", t: "В огне",   c: "rgba(230,240,255,0.24)" },
  ];
