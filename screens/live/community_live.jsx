          ...
          <React.Fragment>
            ...
            <button onClick={() => { if (window.tgHaptic) { try { window.tgHaptic("selection"); } catch (e) {} } navigate("guide", { from: "community" }); }} className="tap"
              style={{ position: "relative", width: "100%", border: 0, borderRadius: 24, padding: "18px 16px 16px", textAlign: "left", overflow: "hidden", cursor: "pointer",
                background: "radial-gradient(120% 110% at 84% 4%, rgba(254,222,52,0.28), transparent 42%), radial-gradient(100% 90% at 8% 110%, rgba(126,210,168,0.18), transparent 52%), linear-gradient(160deg,#101a2d 0%,#08111f 62%,#050a12 100%)",
              ...
              <div style={{ position: "relative", display: "flex", alignItems: "center", gap: 14 }}>
                <div style={{ flex: 1, minWidth: 0 }}>
                  <div style={{ fontSize: 10.5, fontWeight: 800, letterSpacing: 1.35, textTransform: "uppercase", color: "rgba(214,224,255,0.66)" }}>✦ путь игрока</div>
                  <div style={{ fontSize: 20, fontWeight: 850, letterSpacing: "-0.55px", color: "#fff", marginTop: 5, lineHeight: 1.12 }}>Сделай ход — открой мир</div>
                  <div style={{ fontSize: 12.5, color: "rgba(226,234,250,0.72)", marginTop: 6, lineHeight: 1.42, maxWidth: 270 }}>Отметка даёт XP, уровень открывает людей, круги и партнёров. Посмотри, куда ведёт первый шаг.</div>
                  <div style={{ display: "flex", flexWrap: "wrap", gap: 5, marginTop: 11 }}>
                    {[["✅", "ход"], ["✦", "XP"], ["⬆", "уровень"], ["🤝", "люди"]].map(function (s, i) {
                  ...
                  <span style={{ display: "inline-flex", alignItems: "center", gap: 6, marginTop: 12, fontSize: 12.5, fontWeight: 800, color: "#0a0a0a", background: "linear-gradient(135deg,#FEDE34,#EF9F14)", borderRadius: 999, padding: "8px 14px", boxShadow: "0 6px 16px rgba(239,159,20,0.34)" }}>Понять игру за 2 минуты ›</span>
                </div>
                <span aria-hidden style={{ position: "relative", width: 70, height: 70, flexShrink: 0, display: "grid", placeItems: "center" }}>
                  ...
                  <span style={{ position: "relative", width: 42, height: 42, borderRadius: "50%", display: "grid", placeItems: "center", background: "linear-gradient(165deg,rgba(255,255,255,0.30),rgba(255,255,255,0.08))", boxShadow: "inset 0 1px 0.5px rgba(255,255,255,0.38), 0 8px 20px rgba(0,0,0,0.30)", fontSize: 24 }}>🙂</span>
                </span>
              </div>
            </button>
