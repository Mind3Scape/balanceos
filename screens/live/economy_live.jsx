  ...
  return (
    <div className="page-in" style={{ padding: "0 16px 28px" }}>
      ...
      <div style={cardStyle}>
        ...
        {body("Нетворк", "С 10 уровня открываются «Люди» — нетворк по делам: кто чем живёт, у кого какой ритм, к кому идти за помощью или партнёрством. Уровень — твой пропуск, и его не купить: только прожить.")}
      </div>
