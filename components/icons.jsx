...
const I = {
  ...
  Group: ({filled, ...p}) => <Icon {...p}><circle cx="9" cy="8" r="3.2" fill={filled ? p.color || "currentColor" : "none"} /><path d="M3 20c0-3.3 2.7-6 6-6s6 2.7 6 6"/><circle cx="17" cy="9" r="2.6" fill={filled ? p.color || "currentColor" : "none"}/><path d="M14.5 14.2c.8-.3 1.6-.4 2.5-.4 2.5 0 4.5 2 4.5 4.5"/></Icon>,
  ...
  Sparkles: (p) => <Icon {...p}><path d="M12 3l1.6 4.4L18 9l-4.4 1.6L12 15l-1.6-4.4L6 9l4.4-1.6L12 3z"/><path d="M19 15l.8 2.2L22 18l-2.2.8L19 21l-.8-2.2L16 18l2.2-.8L19 15z"/></Icon>,
