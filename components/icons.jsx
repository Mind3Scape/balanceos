...
const I = {
  ...
  Sun: ({filled, ...p}) => <Icon {...p}><circle cx="12" cy="12" r="4.1" fill={filled ? p.color || "currentColor" : "none"}/><path d="M12 3v2.2M12 18.8V21M3 12h2.2M18.8 12H21M5.8 5.8l1.6 1.6M16.6 16.6l1.6 1.6M18.2 5.8l-1.6 1.6M7.4 16.6l-1.6 1.6"/></Icon>,
