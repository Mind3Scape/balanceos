...
const I = {
  ...
  Galaxy: (p) => <Icon {...p}><path d="M14.5 4.3C19.5 6 21 11.5 18 15.5 15.5 18.8 10 19.5 6.8 16.8 4.2 14.6 4.2 10.8 6.8 9 8.9 7.5 11.8 8.2 12.6 10.4"/><path d="M9.5 19.7C4.5 18 3 12.5 6 8.5 8.5 5.2 14 4.5 17.2 7.2 19.8 9.4 19.8 13.2 17.2 15 15.1 16.5 12.2 15.8 11.4 13.6"/><circle cx="12" cy="12" r="1.3" fill="currentColor" stroke="none"/></Icon>,
