...
const PRECACHE = [
  ...
  "build/components/icons.js?v=v483",
  "build/components/shell.js?v=v483",
  "build/core/aliases.js?v=v483",
  "build/core/home-kit.js?v=v483",
  "build/core/habits-kit.js?v=v483",
  "build/core/profile-kit.js?v=v483",
  "build/core/community-kit.js?v=v483",
  "build/core/extra-kit.js?v=v483",
  "build/screens/demo/profile.js?v=v483",
  "build/screens/demo/extra.js?v=v483",
  "build/screens/intro.js?v=v483",
  "build/screens/live/economy_live.js?v=v483",
  "build/screens/live/shared_live.js?v=v483",
  "build/screens/live/home_live.js?v=v483",
  "build/screens/live/habits_live.js?v=v483",
  "build/screens/live/profile_live.js?v=v483",
  "build/screens/live/community_live.js?v=v483",
  "build/screens/live/home_extra_live.js?v=v483",
  "build/screens/live/habits_extra_live.js?v=v483",
  "build/screens/live/profile_extra_live.js?v=v483",
  "build/screens/live/community_extra_live.js?v=v483",
  "build/screens/live/extra_live.js?v=v483",
  "build/app.js?v=v483",
  /* BUILD_PRECACHE_END */
  "assets/sphere.png",
