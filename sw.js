...
const PRECACHE = [
  ...
  "build/components/icons.js?v=v620",
  "build/components/shell.js?v=v620",
  "build/core/aliases.js?v=v620",
  "build/core/home-kit.js?v=v620",
  "build/core/habits-kit.js?v=v620",
  "build/core/profile-kit.js?v=v620",
  "build/core/community-kit.js?v=v620",
  "build/core/extra-kit.js?v=v620",
  "build/screens/demo/profile.js?v=v620",
  "build/screens/demo/extra.js?v=v620",
  "build/screens/intro.js?v=v620",
  "build/screens/live/economy_live.js?v=v620",
  "build/screens/live/shared_live.js?v=v620",
  "build/screens/live/home_live.js?v=v620",
  "build/screens/live/habits_live.js?v=v620",
  "build/screens/live/env_balance_live.js?v=v620",
  "build/screens/live/profile_live.js?v=v620",
  "build/screens/live/community_live.js?v=v620",
  "build/screens/live/home_extra_live.js?v=v620",
  "build/screens/live/habits_extra_live.js?v=v620",
  "build/screens/live/profile_extra_live.js?v=v620",
  "build/screens/live/community_extra_live.js?v=v620",
  "build/screens/live/extra_live.js?v=v620",
  "build/app.js?v=v620",
  /* BUILD_PRECACHE_END */
  "assets/sphere.png",
