...
const PRECACHE = [
  ...
  "build/components/icons.js?v=v265",
  "build/components/shell.js?v=v265",
  "build/core/aliases.js?v=v265",
  "build/core/home-kit.js?v=v265",
  "build/core/habits-kit.js?v=v265",
  "build/core/profile-kit.js?v=v265",
  "build/core/community-kit.js?v=v265",
  "build/core/extra-kit.js?v=v265",
  "build/screens/demo/profile.js?v=v265",
  "build/screens/demo/extra.js?v=v265",
  "build/screens/intro.js?v=v265",
  "build/screens/live/economy_live.js?v=v265",
  "build/screens/live/shared_live.js?v=v265",
  "build/screens/live/home_live.js?v=v265",
  "build/screens/live/habits_live.js?v=v265",
  "build/screens/live/profile_live.js?v=v265",
  "build/screens/live/community_live.js?v=v265",
  "build/screens/live/home_extra_live.js?v=v265",
  "build/screens/live/habits_extra_live.js?v=v265",
  "build/screens/live/profile_extra_live.js?v=v265",
  "build/screens/live/community_extra_live.js?v=v265",
  "build/screens/live/extra_live.js?v=v265",
  "build/app.js?v=v265",
  /* BUILD_PRECACHE_END */
  "assets/sphere.png",
