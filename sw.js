...
const PRECACHE = [
  ...
  "build/components/icons.js?v=v699",
  "build/components/shell.js?v=v699",
  "build/core/aliases.js?v=v699",
  "build/core/home-kit.js?v=v699",
  "build/core/habits-kit.js?v=v699",
  "build/core/profile-kit.js?v=v699",
  "build/core/community-kit.js?v=v699",
  "build/core/extra-kit.js?v=v699",
  "build/screens/demo/profile.js?v=v699",
  "build/screens/demo/extra.js?v=v699",
  "build/screens/intro.js?v=v699",
  "build/screens/live/economy_live.js?v=v699",
  "build/screens/live/shared_live.js?v=v699",
  "build/screens/live/home_live.js?v=v699",
  "build/screens/live/habits_live.js?v=v699",
  "build/screens/live/env_balance_live.js?v=v699",
  "build/screens/live/profile_live.js?v=v699",
  "build/screens/live/community_live.js?v=v699",
  "build/screens/live/home_extra_live.js?v=v699",
  "build/screens/live/habits_extra_live.js?v=v699",
  "build/screens/live/profile_extra_live.js?v=v699",
  "build/screens/live/community_extra_live.js?v=v699",
  "build/screens/live/extra_live.js?v=v699",
  "build/app.js?v=v699",
  /* BUILD_PRECACHE_END */
  "assets/sphere.png",
