...
const PRECACHE = [
  ...
  "build/components/icons.js?v=v218",
  "build/components/shell.js?v=v218",
  "build/core/aliases.js?v=v218",
  "build/core/home-kit.js?v=v218",
  "build/core/habits-kit.js?v=v218",
  "build/core/profile-kit.js?v=v218",
  "build/core/community-kit.js?v=v218",
  "build/core/extra-kit.js?v=v218",
  "build/screens/demo/home.js?v=v218",
  "build/screens/demo/habits.js?v=v218",
  "build/screens/demo/community.js?v=v218",
  "build/screens/demo/profile.js?v=v218",
  "build/screens/demo/extra.js?v=v218",
  "build/screens/intro.js?v=v218",
  "build/screens/live/economy_live.js?v=v218",
  "build/screens/live/shared_live.js?v=v218",
  "build/screens/live/home_live.js?v=v218",
  "build/screens/live/habits_live.js?v=v218",
  "build/screens/live/profile_live.js?v=v218",
  "build/screens/live/community_live.js?v=v218",
  "build/screens/live/home_extra_live.js?v=v218",
  "build/screens/live/habits_extra_live.js?v=v218",
  "build/screens/live/profile_extra_live.js?v=v218",
  "build/screens/live/community_extra_live.js?v=v218",
  "build/screens/live/extra_live.js?v=v218",
  "build/app.js?v=v218",
  /* BUILD_PRECACHE_END */
  "assets/sphere.png",
