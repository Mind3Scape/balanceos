...
const PRECACHE = [
  ...
  "build/components/icons.js?v=v717",
  "build/components/shell.js?v=v717",
  "build/core/aliases.js?v=v717",
  "build/core/home-kit.js?v=v717",
  "build/core/habits-kit.js?v=v717",
  "build/core/profile-kit.js?v=v717",
  "build/core/community-kit.js?v=v717",
  "build/core/extra-kit.js?v=v717",
  "build/screens/demo/profile.js?v=v717",
  "build/screens/demo/extra.js?v=v717",
  "build/screens/intro.js?v=v717",
  "build/screens/live/economy_live.js?v=v717",
  "build/screens/live/shared_live.js?v=v717",
  "build/screens/live/home_live.js?v=v717",
  "build/screens/live/habits_live.js?v=v717",
  "build/screens/live/env_balance_live.js?v=v717",
  "build/screens/live/profile_live.js?v=v717",
  "build/screens/live/community_live.js?v=v717",
  "build/screens/live/home_extra_live.js?v=v717",
  "build/screens/live/habits_extra_live.js?v=v717",
  "build/screens/live/profile_extra_live.js?v=v717",
  "build/screens/live/community_extra_live.js?v=v717",
  "build/screens/live/extra_live.js?v=v717",
  "build/app.js?v=v717",
  /* BUILD_PRECACHE_END */
  "assets/sphere.png",
